    ...
    Student.destroy({
      ...
      .then(() => {
        res
          ...
          .json({ result: "Student deleted successfuly" });
      })
      .catch((e) => {
  ...
  updateStudentName: (req, res, next) => {
    ...
    Student.update(
      ...
      .then(() => {
        res
          .status(httpStatus.OK)
          .json({ result: "Student name updated successfuly" });
      })
      .catch((e) => {
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message });
      });
  ...
  updateStudentPhone: (req, res, next) => {
    ...
    Student.update(
      ...
      .then(() => {
        res
          .status(httpStatus.OK)
          .json({ result: "Student phone updated successfuly" });
      })
      .catch((e) => {
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message });
      });
  ...
  updateStudentPassword: (req, res, next) => {
    ...
    Student.update(
      ...
      .then(() => {
        res
          .status(httpStatus.OK)
          .json({ result: "Student password updated successfuly" });
      })
      .catch((e) => {
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message });
      });
