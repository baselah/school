...
module.exports = {
  addCourse: (req, res, next) => {
    const { price, details, s_id } = req.body;
    ...
    course
      ...
      .then(() => {
        res
          ...
          .json({ result: "Course deleted successfully" });
      })
      .catch((e) => {
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message });
      });
  ...
  updateCoursePrice: (req, res, next) => {
    ...
    course
      ...
      .then(() =>
        res
          .status(httpStatus.OK)
          .json({ result: "Course Price updated successfuly" })
      )
      .catch((e) =>
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message })
      );
  ...
  updateCourseDetails: (req, res, next) => {
    ...
    course
      ...
      .then(() =>
        res
          .status(httpStatus.OK)
          .json({ result: "Course Details updated successfuly" })
      )
      .catch((e) =>
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message })
      );
  ...
  updateCourseSubject: (req, res, next) => {
    ...
    course
      ...
      .then(() =>
        res
          .status(httpStatus.OK)
          .json({ result: "Course Subject updated successfuly" })
      )
      .catch((e) =>
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message })
      );
  ...
  getAllCourses: (req, res, next) => {
    course
      .findAll()
      .then((result) => res.status(httpStatus.OK).json({ result: result }))
      .catch((e) =>
        res.status(httpStatus.BAD_REQUEST).json({ result: e.message })
      );
  },
